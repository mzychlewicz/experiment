...
#
#  $RCSfile: PII_speed.mk $ $Revision: 2.47 $ $Date: 2012/01/11 14:30:56MEZ $
#  $ProjectName: e:/ARC/Products/ImplSW/RTISW/RTI/Components/Build/Makefile/project.pj $
# =============================================================================
# NEVER CHANGE THIS LINE:
# RTI_TEMPLATE_MAKEFILE_VERSION = 180
# =============================================================================
...
MATLAB_ROOT                    = D:\Program Files (x86)\MATLAB\R2010a
MATLAB_BIN                     = D:\Program Files (x86)\MATLAB\R2010a\bin
MATLAB_ROOT_ALT                = D:\PROGRA~2\MATLAB\R2010a
MATLAB_BIN_ALT                 = D:\PROGRA~2\MATLAB\R2010a\bin
RELEASE_VERSION                = R2010a
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN
MODEL                          = PII_speed
MODULES                        = PII_speed_data.c PII_speed_trc_ptr.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c rt_zcfcn.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 4
...
MASTER_ANCHOR_DIR              = 
START_DIR                      = D:\Users\lab101\Desktop\student_experiment\experiment_ANN_bp_2f_controller
# Shared library for utility code
RTW_SHARED_LIB_SRCS_WILD       = 
RTW_SHARED_LIB_SRCS_DIR        = 
RTW_SHARED_LIB_OBJS_DIR        = 
RTW_SHARED_LIB                 = 
RTW_MODELLIB                   = PII_speedlib.lib
