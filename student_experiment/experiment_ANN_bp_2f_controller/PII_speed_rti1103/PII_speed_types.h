 ...
 */
#ifndef RTW_HEADER_PII_speed_types_h_
#define RTW_HEADER_PII_speed_types_h_
#include "rtwtypes.h"
...
typedef struct Parameters_PII_speed_ Parameters_PII_speed;

/* Forward declaration for rtModel */
typedef struct RT_MODEL_PII_speed RT_MODEL_PII_speed;

#endif                                 /* RTW_HEADER_PII_speed_types_h_ */
