/************************ dSPACE target specific file *************************
   ...
   Include file .\pii_speed_rti1103\PII_speed_th.c :

   Task Configuration file for model : PII_speed

   RTI1103 6.9 (02-May-2012)/2.4
   17-Dec-2015 12:35:21
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\pii_speed_rti1103\PII_speed_th.c is for ST).
# endif
